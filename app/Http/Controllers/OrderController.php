...
//                    }
    ...
    public function checkWebhooks($id) {
        ...
        dd($shopify);
        try {
           $shopify_result = $shopify->call(['URL' => 'inventory_levels/adjust.json', 'METHOD' => 'POST', "DATA" => ["location_id" => '15732867124', "inventory_item_id" => '8495831253044', "available_adjustment" => 100]]);
        } catch (\Exception $e) {
            dd($e->getMessage());
        }
